...
public class Drive extends SubsystemBase {
  ...
  private final CANSparkMax m_leftMotor = new CANSparkMax(DriveConstants.kLeftMotor1Port, CANSparkLowLevel.MotorType.kBrushed);
  private final CANSparkMax m_rightMotor = new CANSparkMax(DriveConstants.kRightMotor1Port,CANSparkLowLevel.MotorType.kBrushed);
  private final CANSparkMax m_rearLeftMotor = new CANSparkMax(DriveConstants.kLeftMotor2Port,CANSparkLowLevel.MotorType.kBrushed);
  private final CANSparkMax m_rearRightMotor = new CANSparkMax(DriveConstants.kRightMotor2Port, CANSparkLowLevel.MotorType.kBrushed);
  ...
  public Drive() {
    ...
    m_rearLeftMotor.follow(m_leftMotor);
    m_rearRightMotor.follow(m_rightMotor);
